...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_HLSPtr_i \
    op interface \
    ports { HLSPtr_i { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fifoEdgeListPtr11_din { O 32 vector } fifoEdgeListPtr11_full_n { I 1 bit } fifoEdgeListPtr11_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 7 \
    name lenEdgeListPtr_c27 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_lenEdgeListPtr_c27 \
    op interface \
    ports { lenEdgeListPtr_c27_din { O 32 vector } lenEdgeListPtr_c27_full_n { I 1 bit } lenEdgeListPtr_c27_write { O 1 bit } } \
} "
}
