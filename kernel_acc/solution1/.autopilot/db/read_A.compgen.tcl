...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_lenEdgePtr \
    op interface \
    ports { lenEdgePtr { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 10 \
    name matrixA_hls_idx \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_matrixA_hls_idx \
    op interface \
    ports { matrixA_hls_idx { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_matrixA_i \
    op interface \
    ports { matrixA_i { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fifoMatrixAIdx12_din { O 32 vector } fifoMatrixAIdx12_full_n { I 1 bit } fifoMatrixAIdx12_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fifoMatrixA13_din { O 32 vector } fifoMatrixA13_full_n { I 1 bit } fifoMatrixA13_write { O 1 bit } } \
} "
}
