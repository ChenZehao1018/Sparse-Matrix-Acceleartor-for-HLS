...
set C_modelArgList {
	{ matrixC_o int 64 regular  }
	{ M int 32 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "matrixC_o", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ matrixC_o sc_in sc_lv 64 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "matrixC_o", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "matrixC_o", "role": "default" }} , 
...
set Spec2ImplPortList { 
	matrixC_o { ap_none {  { matrixC_o in_data 0 64 } } }
