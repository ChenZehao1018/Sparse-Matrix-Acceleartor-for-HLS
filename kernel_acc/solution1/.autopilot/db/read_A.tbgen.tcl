...
set C_modelArgList {
	{ lenEdgePtr int 32 regular  }
	{ gmem1 int 32 regular {axi_master 0}  }
	{ matrixA_hls_idx int 64 regular  }
	{ gmem2 int 32 regular {axi_master 0}  }
	{ matrixA_i int 64 regular  }
	{ fifoMatrixAIdx12 int 32 regular {fifo 1 volatile }  }
	{ fifoMatrixA13 int 32 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "lenEdgePtr", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "matrixA_hls_idx", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "matrixA_i", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "fifoMatrixAIdx12", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "fifoMatrixA13", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ lenEdgePtr sc_in sc_lv 32 signal 0 } 
	...
	{ matrixA_hls_idx sc_in sc_lv 64 signal 2 } 
	...
	{ matrixA_i sc_in sc_lv 64 signal 4 } 
	{ fifoMatrixAIdx12_din sc_out sc_lv 32 signal 5 } 
	{ fifoMatrixAIdx12_full_n sc_in sc_logic 1 signal 5 } 
	{ fifoMatrixAIdx12_write sc_out sc_logic 1 signal 5 } 
	{ fifoMatrixA13_din sc_out sc_lv 32 signal 6 } 
	{ fifoMatrixA13_full_n sc_in sc_logic 1 signal 6 } 
	{ fifoMatrixA13_write sc_out sc_logic 1 signal 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "lenEdgePtr", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "lenEdgePtr", "role": "default" }} , 
 	...
 	{ "name": "matrixA_hls_idx", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "matrixA_hls_idx", "role": "default" }} , 
 	...
 	{ "name": "matrixA_i", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "matrixA_i", "role": "default" }} , 
 	{ "name": "fifoMatrixAIdx12_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fifoMatrixAIdx12", "role": "din" }} , 
 	{ "name": "fifoMatrixAIdx12_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fifoMatrixAIdx12", "role": "full_n" }} , 
 	{ "name": "fifoMatrixAIdx12_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fifoMatrixAIdx12", "role": "write" }} , 
 	{ "name": "fifoMatrixA13_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fifoMatrixA13", "role": "din" }} , 
 	{ "name": "fifoMatrixA13_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fifoMatrixA13", "role": "full_n" }} , 
 	{ "name": "fifoMatrixA13_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fifoMatrixA13", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "fifoMatrixAIdx12", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "32", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "fifoMatrixAIdx12_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "fifoMatrixA13", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "32", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	lenEdgePtr { ap_none {  { lenEdgePtr in_data 0 32 } } }
	...
	matrixA_hls_idx { ap_none {  { matrixA_hls_idx in_data 0 64 } } }
	...
	matrixA_i { ap_none {  { matrixA_i in_data 0 64 } } }
	fifoMatrixAIdx12 { ap_fifo {  { fifoMatrixAIdx12_din fifo_data 1 32 }  { fifoMatrixAIdx12_full_n fifo_status 0 1 }  { fifoMatrixAIdx12_write fifo_update 1 1 } } }
	fifoMatrixA13 { ap_fifo {  { fifoMatrixA13_din fifo_data 1 32 }  { fifoMatrixA13_full_n fifo_status 0 1 }  { fifoMatrixA13_write fifo_update 1 1 } } }
}
